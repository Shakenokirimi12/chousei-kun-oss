/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: d3eecafde7485d72cf0717e608291a84)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CAMPUS_SQUARE_BASE_URL: string;
		CAMPUS_SQUARE_LOGIN_WFID: string;
		CAMPUS_SQUARE_CALENDAR_FLOWID: string;
		CAMPUS_SQUARE_TIMEZONE_OFFSET: string;
		NEXT_PUBLIC_ENABLE_CAMPUS_SQUARE: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		GOOGLE_REDIRECT_URI: string;
		OPENCODE_API_KEY: string;
		NEXT_PUBLIC_ENABLE_AI_SCHEDULING: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CAMPUS_SQUARE_BASE_URL" | "CAMPUS_SQUARE_LOGIN_WFID" | "CAMPUS_SQUARE_CALENDAR_FLOWID" | "CAMPUS_SQUARE_TIMEZONE_OFFSET" | "NEXT_PUBLIC_ENABLE_CAMPUS_SQUARE" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_REDIRECT_URI" | "OPENCODE_API_KEY" | "NEXT_PUBLIC_ENABLE_AI_SCHEDULING">> {}
}
